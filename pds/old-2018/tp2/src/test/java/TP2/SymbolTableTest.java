...
public class SymbolTableTest extends TestCase {
  ...
  public static void testSimple() {
    SymbolTable table = new SymbolTable();
    SymbolTable.Symbol sym = new SymbolTable.VariableSymbol(new ASD.Int(), "key");
  ...
  public static void testParent() {
    ...
    SymbolTable.Symbol sym2 = new SymbolTable.VariableSymbol(new ASD.Int(), "key2");
  ...
  public static void testEquals() {
    ...
    SymbolTable.VariableSymbol arg0 = new SymbolTable.VariableSymbol(new ASD.Int(), "arg0");
    SymbolTable.VariableSymbol arg1 = new SymbolTable.VariableSymbol(new ASD.Int(), "arg1");
    arguments.add(0, arg0);
    arguments.add(0, arg1);

    SymbolTable.Symbol fun = new SymbolTable.FunctionSymbol(new ASD.Int(), "fun", arguments, true);
    SymbolTable.Symbol fun2 = new SymbolTable.FunctionSymbol(new ASD.Int(), "fun2", new ArrayList<SymbolTable.VariableSymbol>(), true);
